...
本项目是基于原 **anime-character-guessr** 项目重构而成的 **化学物质猜测游戏**。保留了原项目的前后端架构（React + Node.js + Express + MongoDB），但将所有动漫角色相关的逻辑、数据和UI替换为高中化学物质/离子根/化合物的猜测游戏。
...
- 原项目：[anime-character-guessr](https://github.com/original-repo)
- 灵感来源：Wordle 类猜测游戏
- 数据来源：高中化学教材
